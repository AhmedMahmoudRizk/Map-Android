...
public class GetNearbyPlaces extends FragmentActivity implements OnMapReadyCallback ,
        ...
        GoogleMap.OnMarkerDragListener
{
    ...
    private void setMarker(double lat ,double lng){
        ...
        Toast.makeText(GetNearbyPlaces.this,"near place ....", Toast.LENGTH_LONG).show();
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    for (DataSnapshot data : dataSnapshot.getChildren()) {
                        if (data.exists()) {
                            String location=(String)data.getValue();
                            Log.e("hhhhhhhh",location);
                            String []v=location.split(",");
                            double lat=Double.parseDouble(v[0]);
                            double log=Double.parseDouble(v[1]);
                            if(caldis(lat,log,latitude,longitude)<80)
                                setMarker(lat,log);
                        }
                    }
                }
